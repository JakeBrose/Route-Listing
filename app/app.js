...
.config($routeProvider => {
            $routeProvider
                .when("/highwayView", {
                    templateUrl: "partials/highwayView.html",
...
app.controller('highwayViewCtrl', function($scope){
    $scope.highwayOneName = 'Pacific Coast Highway';
    $scope.highwayTwoName = 'Route 66';
});
